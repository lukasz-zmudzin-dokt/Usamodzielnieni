...
const renderWithRouter = (
    ...
    let context = { type: userTypes.STAFF, data: {group_type: [staffTypes.BLOG_CREATOR]} };
    return {
        ...render(
...
describe('BlogpostForm', () => {
    ...
    it('should redirect to post url', async () => {
        ...
        await expect(history.location.pathname).toBe('/blog/blogpost/' + post.post_id, {exact: false});
    });
