...
import { downloadCV } from "Views/CVApprovalPage/functions/downloadCV";
    ...
    return (
        <Row className="mt-3">
            ...
            <Col xs={12} md={4} className="d-flex justify-content-end">
                <Button variant="primary m-1 p-1" className="btnDownload" onClick={e => (showCV(cv.cv_id, token))}>Pokaż CV</Button>
