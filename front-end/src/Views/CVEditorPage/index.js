...
import {handleCVSubmit,handleAddLanguage,handleLanChange,handleLanLvlChange,handleSkillAdd} from 'Views/CVEditorPage/functions/handlers.js';
                            ...
                            <Col>
                                <Tabs activeKey={this.state.formTab} onSelect={e => this.setState({ formTab: e })} id="tabs">
                                    <Tab eventKey="personalData" title="Dane osobowe">
                                        <PersonalDataTab onNextButtonClick={() => this.setState({ formTab: "education" })}/>
                                    </Tab>
