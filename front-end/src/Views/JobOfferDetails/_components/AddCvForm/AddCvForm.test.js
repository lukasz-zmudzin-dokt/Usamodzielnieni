...
describe('AddCvForm', () => {
    ...
    it('should render error alert when api returns error after click', async () => {
        ...
        expect(alertC.showAlert).toHaveBeenCalledWith("Wystąpił błąd podczas składania aplikacji na ofertę.");
    });
    ...
    it('should render fail alert when api returns already added status after click', async () => {
        ...
        await wait(() => expect(alertC.showAlert).toHaveBeenCalled());
        expect(alertC.showAlert).toHaveBeenCalledWith("Już zaaplikowano do danego ogłoszenia.");
    });
    ...
    it('should render success alert when api returns success after click', async () => {
        ...
        await wait(() => expect(alertC.showAlert).toHaveBeenCalled());
        expect(alertC.showAlert).toHaveBeenCalledWith("Pomyślnie zaaplikowano do ogłoszenia.", "success");
    });
