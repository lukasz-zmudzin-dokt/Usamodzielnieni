...
const RemoveOffer = ({ id, user }) => {
    ...
    const msg =  (deleted && deletionError) ?
    ...
    return (
        <div className="removeOffer">
            {DeletionModal(showModal, setShowModal, setDeletionConfirmed, "Czy na pewno chcesz usunąć tę ofertę?")}
            {msg || <Button variant="danger" onClick={handleOnClick}>Usuń ofertę</Button>}
        </div>
    )
}
