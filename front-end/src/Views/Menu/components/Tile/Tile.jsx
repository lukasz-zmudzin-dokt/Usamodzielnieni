...
const Tile = ({ title, showImage, imageUrl, color, destination, user, previewOnly, cutTile }) => {
      ...
      </Link>
      {
        !previewOnly && user.data?.group_type.includes(staffTypes.BLOG_MODERATOR) && (
            <div className="tile__button__container">
              <Button size="sm" className="tile__button tile__button__edit" variant="primary">
                <img className="tile__button__edit__icon" src="/editicon.svg" alt="Edytuj"/>
              </Button>
              <Button size="sm" className="tile__button tile__button__delete" variant="danger">
