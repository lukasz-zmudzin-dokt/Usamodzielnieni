        ...
        <Card className="loginPage__card loginPage__card--login">
          ...
          <Card.Body className="loginPage__body">
            ...
            <div className="submit_message">
              {validated ? (
                correct ? (
                  <Alert variant="success" className="mt-2 msg_text">
                    Jeżeli Twoje konto istnieje, to właśnie otrzymałeś maila.
                    Sprawdź skrzynkę i przejdź dalej!
                  </Alert>
                ) : (
                  <Alert variant="danger" className="mt-2 msg_text">
                    Coś poszło nie tak.
                  </Alert>
                )
              ) : null}
