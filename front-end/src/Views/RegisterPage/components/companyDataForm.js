                ...
                <Card.Body className="">
                    <Form.Group controlId="formGroupNameOfPlace">
                        <Form.Control
                            ...
                            onBlur={e => onChange(this, e, "company_name")}
                            required
                        />
                    ...
                    <Form.Group controlId="formGroupCity" className="">
                        <Form.Control
                            ...
                            onBlur={e => onChange(this, e, "company_city")}
                            required
                        />
                        <Form.Control.Feedback type="invalid">
                            Podaj nazwę miasta
                    ...
                    <Form.Group controlId="formGroupCityCode" className="">
                        <Form.Control
                            ...
                            onChange={e => onChange(this, e, "company_postal_code")}
                            required
                        />
                        <Form.Control.Feedback type="invalid">
                            Podaj kod pocztowy
                    ...
                    <Form.Group controlId="formGroupCompanyNip" className="">
                        <Form.Control
                            ...
                            onChange={e => onChange(this, e, "company_nip")}
                            required
                        />
                        <Form.Control.Feedback type="invalid">
                            Podaj NIP
